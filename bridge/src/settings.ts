import type { EngraveType, Settings } from "./types";
...
// Material presets (data only, no textures)
...
export const MATERIAL_PRESETS: Record<MaterialPresetId, MaterialPresetData> = {
  Oak: { id: "Oak", label: "Oak", defaultDepthMm: 1.6, defaultPasses: 2 },
  MDF: { id: "MDF", label: "MDF", defaultDepthMm: 1.2, defaultPasses: 2 },
  OSB: { id: "OSB", label: "OSB", defaultDepthMm: 2, defaultPasses: 3 },
};

export const MATERIAL_PRESET_LIST: MaterialPresetData[] = [
